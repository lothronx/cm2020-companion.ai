...
export default function Chat() {
  ...
  return (
    <div className="h-screen md:container md:mx-auto shadow-lg rounded-lg">
      ...
      <main className="bg-base-100 h-5/6">
        <section className="flex flex-col w-full h-full px-4 overflow-auto">
        ...
        <form
          className="flex w-full h-10 py-2 px-4"
          ...
          />
          <button className="px-4 py-2" type="submit" disabled={isSubmitting || isTyping}>
